...
def treinar_classificador(
    ...
    fe = Pipeline(steps=[
        ("datas", DatasFeaturesTransformer(col_dt="partida_prevista",
                                           col_atraso="atraso_partida_min"  
                                           )),
        ("ultimate", UltimateFeatureEngineer()),
        ("medias", MediaAtrasoTransformer(col_atraso="atraso_partida_min")),
        ("drop_leakage", DropColumnsTransformer(drop)),
        ])
